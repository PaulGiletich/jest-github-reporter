...
function createAnnotations(results) {
    return __awaiter(this, void 0, void 0, function () {
        var gitRoot, annotations, _loop_1, results_1, results_1_1, result;
        var e_1, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, execa_1.execa('git', ['rev-parse', '--show-toplevel'])];
                case 1:
                    gitRoot = (_b.sent()).stdout;
                    annotations = [];
                            ...
                            if ('location' in failure) {
                                ...
                                if (location_1) {
                                    failureMessages_1.forEach(function (message) {
                                        ...
                                        var start_line = numbers
                                            ? Number(numbers[1])
                                            : location_1.line || 0;
                                        annotations.push({
                                            path: path_1.default.relative(gitRoot, testFilePath),
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, createAnnotations(results.testResults)];
            case 1: return [2 /*return*/, _a.apply(void 0, [(_b.annotations = _c.sent(),
                        _b.errorCount = results.numFailedTests,
                        _b.appId = process.env.JEST_APP_ID ? Number(process.env.JEST_APP_ID) : APP_ID,
                        _b.privateKey = process.env.JEST_PRIVATE_KEY || PRIVATE_KEY,
                        _b)])];
        }
    });
}); });
